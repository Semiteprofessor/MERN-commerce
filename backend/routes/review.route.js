...
const ReviewController = require("../controllers/review.ctl");
...
router.get(
  "/admin/app-reviews",
  verifyToken,
  ReviewController.getReviewsByAdmin
); // Get all app reviews for admin
router.get(
  "/admin/app-reviews/:rid",
  verifyToken,
  ReviewController.getOneReviewByAdmin
); // Get a single app review by ID for admin
router.post(
  "/admin/app-reviews",
  verifyToken,
  ReviewController.createReviewByAdmin
); // Create a new app review by admin
router.put(
  "/admin/app-reviews/:rid",
  verifyToken,
  ReviewController.updateReviewByAdmin
); // Update an existing app review by admin
router.delete(
  "/admin/app-reviews/:rid",
  verifyToken,
  ReviewController.deleteReviewByAdmin
); // Delete an existing app review by admin
